! function(t) {
    var e, r, i = "0.4.2",
        ...
        u = function(t, i) {
            ...
            var n, a = r,
                ...
                d = e;
            e = t, r = 0;
            for (var g = 0, v = o.length; v > g; g++) "zIndex" in o[g] && (c.push(o[g].zIndex), o[g].zIndex < 0 && (f[o[g].zIndex] = o[g]));
            for (c.sort(l); c[h] < 0;)
            ...
            for (g = 0; v > g; g++)
                if (n = o[g], "zIndex" in n)
                    if (n.zIndex == c[h]) {
                        ...
                        do
                            if (h++, n = f[c[h]], n && p.push(n.apply(i, s)), r) break;
                        while (n)
                    } else f[n.zIndex] = n;
    ...
    }, window.eve = u, "undefined" != typeof module && module.exports ? module.exports = u : "undefined" != typeof define ? define("raphael.js", [], function() {
        return u
    }) : t.eve = u
}(window || this),
function(t, e) {
    ...
    function f(t, e, i) {
        ...
        for (var s = h.apply(0, t), o = h.apply(0, e), l = D(~~(s / 5), 1), u = D(~~(o / 5), 1), f = [], p = [], d = {}, g = i ? 0 : [], v = 0; l + 1 > v; v++) {
        ...
        for (v = 0; l > v; v++)
            for (var y = 0; u > y; y++) {
                ...
                if (B) {
                    ...
                    var S = m.t + O((B[k] - m[k]) / (b[k] - m[k])) * (b.t - m.t),
                        T = _.t + O((B[C] - _[C]) / (w[C] - _[C])) * (w.t - _.t);
    ...
    r.color = function(t) {
        ...
        var n, a, s, o, l;
        return t = t % 360 / 60, l = r * e, o = l * (1 - O(t % 2 - 1)), n = a = s = r - l, t = ~~t, n += [l, o, 0, 0, o, l][t], a += [o, l, l, o, 0, 0][t], s += [0, 0, o, l, l, o][t], Be(n, a, s, i)
    }, r.hsl2rgb = function(t, e, r, i) {
        this.is(t, "object") && "h" in t && "s" in t && "l" in t && (r = t.l, e = t.s, t = t.h), (t > 1 || e > 1 || r > 1) && (t /= 360, e /= 100, r /= 100), t *= 360;
        var n, a, s, o, l;
        return t = t % 360 / 60, l = 2 * e * (.5 > r ? r : 1 - r), o = l * (1 - O(t % 2 - 1)), n = a = s = r - l / 2, t = ~~t, n += [l, o, 0, 0, o, l][t], a += [o, l, l, o, 0, 0][t], s += [0, 0, o, l, l, o][t], Be(n, a, s, i)
    }, r.rgb2hsb = function(t, e, r) {
        r = Ce(t, e, r), t = r[0], e = r[1], r = r[2];
        var i, n, a, s;
        return a = D(t, e, r), s = a - V(t, e, r), i = 0 == s ? null : a == t ? (e - r) / s : a == e ? (r - t) / s + 2 : (t - e) / s + 4, i = (i + 360) % 6 * 60 / 360, n = 0 == s ? 0 : s / a, {
            h: i,
            s: n,
            b: a,
            toString: _e
        ...
        r = Ce(t, e, r), t = r[0], e = r[1], r = r[2];
        var i, n, a, s, o, l;
        return s = D(t, e, r), o = V(t, e, r), l = s - o, i = 0 == l ? null : s == t ? (e - r) / l : s == e ? (r - t) / l + 2 : (t - e) / l + 4, i = (i + 360) % 6 * 60 / 360, a = (s + o) / 2, n = 0 == l ? 0 : .5 > a ? l / (2 * a) : l / (2 - 2 * a), {
            h: i,
            s: n,
            l: a,
            toString: we
    ...
    r.findDotsAtSegment = function(t, e, r, i, n, a, s, o, l) {
        ...
        var n = r.pathBBox(t);
        return r.isPointInsideBBox(n, e, i) && p(t, [
            ["M", e, i],
            ["H", n.x2 + 10]
        ], 1) % 2 == 1
    ...
    var Te = r.pathBBox = function(t) {
        ...
        Pe = function(t, e, r, i, n, s, o, l, h, u) {
            ...
            if (u) C = u[0], B = u[1], w = u[2], k = u[3];
                ...
                var m = r * r,
                    b = i * i,
                    _ = (s == o ? -1 : 1) * q.sqrt(O((m * b - m * x * x - b * v * v) / (m * x * x + b * v * v))),
                    w = _ * r * x / i + (t + l) / 2,
                    k = _ * -i * v / r + (e + h) / 2,
            ...
            var L = q.cos(C),
                ...
                Y = [l + I * z, h - j * P],
                W = [l, h];
            if (V[0] = 2 * D[0] - V[0], V[1] = 2 * D[1] - V[1], u) return [V, Y, W][E](d);
            d = [V, Y, W][E](d).join()[F](",");
        ...
        Fe = a(function(t, e, r, i, n, a, s, o) {
            var l, h = n - 2 * r + t - (s - 2 * n + r),
                ...
                d = [e, o],
                g = [t, s];
            return O(f) > "1e12" && (f = .5), O(p) > "1e12" && (p = .5), f > 0 && 1 > f && (l = ze(t, e, r, i, n, a, s, o, f), g.push(l.x), d.push(l.y)), p > 0 && 1 > p && (l = ze(t, e, r, i, n, a, s, o, p), g.push(l.x), d.push(l.y)), h = a - 2 * i + e - (o - 2 * a + i), u = 2 * (i - e) - 2 * (a - i), c = e - i, f = (-u + q.sqrt(u * u - 4 * h * c)) / 2 / h, p = (-u - q.sqrt(u * u - 4 * h * c)) / 2 / h, O(f) > "1e12" && (f = .5), O(p) > "1e12" && (p = .5), f > 0 && 1 > f && (l = ze(t, e, r, i, n, a, s, o, f), g.push(l.x), d.push(l.y)), p > 0 && 1 > p && (l = ze(t, e, r, i, n, a, s, o, p), g.push(l.x), d.push(l.y)), {
                min: {
                    x: V[N](0, g),
                    y: V[N](0, d)
                },
            ...
            for (var i = Ee(t), n = e && Ee(e), a = {
                    ...
                    switch (!(t[0] in a) && (e.qx = e.qy = null), t[0]) {
                        ...
                        case "S":
                            ...
                            break;
                        case "T":
                            "Q" == r || "T" == r ? (e.qx = 2 * e.x - e.qx, e.qy = 2 * e.y - e.qy) : (e.qx = e.x, e.qy = e.y), t = ["C"][E](Me(e.x, e.y, e.qx, e.qy, t[1], t[2]));
                            break;
                        case "Q":
    ...
    _.safari = "Apple Computer, Inc." == navigator.vendor && (Oe && Oe[1] < 4 || "iP" == navigator.platform.slice(0, 2)) || "Google Inc." == navigator.vendor && Oe && Oe[1] < 8 ? function() {
    ...
    Je.drag = function(t, i, n, a, s, o) {
        function l(l) {
            ...
            this._drag.x = h + f, this._drag.y = u + c, !$e.length && r.mousemove(Ze).mouseup(Qe), $e.push({
                el: this,
                move_scope: a,
                start_scope: s,
                end_scope: o
            }), i && e.on("raphael.drag.start." + this.id, i), t && e.on("raphael.drag.move." + this.id, t), n && e.on("raphael.drag.end." + this.id, n), e("raphael.drag.start." + this.id, s || a || this, l.clientX + f, l.clientY + c, l)
        }
    ...
    var or = r.easing_formulas = {
        ...
        elastic: function(t) {
            return t == !!t ? t : Y(2, -10 * t) * q.sin(2 * (t - .075) * G / .3) + 1
        },
        bounce: function(t) {
            var e, r = 7.5625,
                i = 2.75;
    ...
    return pr.attr = function(t, e) {
            ...
            return t = V[N](0, t), e = V[N](0, e), r = D[N](0, r), i = D[N](0, i), {
                x: t,
                y: e,
                x2: r,
                y2: i,
                                ...
                                switch (u[d] = g, d) {
                                    ...
                                    case "clip-rect":
                                        ...
                                        if (4 == S.length) {
                                            ...
                                            var T = v("clipPath"),
                                                A = v("rect");
                                            T.id = r.createUUID(), v(A, {
                                                x: S[0],
                                                y: S[1],
                                                width: S[2],
                                                height: S[3]
                                            }), T.appendChild(A), i.paper.defs.appendChild(T), v(l, {
                                                "clip-path": "url(#" + T.id + ")"
                                            }), i.clip = A
                                        }
                                        if (!g) {
                                            ...
                                            if (N) {
                                                var E = r._g.doc.getElementById(N.replace(/(^url\(#|\)$)/g, c));
                                    ...
                                    case "stroke-dasharray":
                                        ...
                                        break;
                                    case "fill":
                                        var L = e(g).match(r._ISURL);
                                        if (L) {
                                            T = v("pattern");
                                            var M = v("image");
                                            T.id = r.createUUID(), v(T, {
                                                    x: 0,
                                                    y: 0,
                                                ...
                                                }(T), i.paper.defs.appendChild(T), v(l, {
                                                    fill: "url(#" + T.id + ")"
                                        ...
                                        if (P.error) {
                                            if (("circle" == i.type || "ellipse" == i.type || "r" != e(g).charAt()) && x(i, g)) {
                                                if ("opacity" in u || "fill-opacity" in u) {
                                                    var z = r._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c));
                                                    if (z) {
                                    ...
                                    case "stroke":
                                        P = r.getRGB(g), l.setAttribute(d, P.hex), "stroke" == d && P[t]("opacity") && v(l, {
                                    ...
                                    case "fill-opacity":
                                        if (u.gradient) {
                                            z = r._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c)), z && (F = z.getElementsByTagName("stop"), v(F[F.length - 1], {
                                                "stop-opacity": g
                                            }));
                                            break
                                        }
                ...
                var S = function(t, r, i) {
                    ...
                    T = function(n, l) {
                        ...
                        if ("arrow-start" in l && S(y, l["arrow-start"]), "arrow-end" in l && S(y, l["arrow-end"], 1), null != l.opacity || null != l["stroke-width"] || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                            ...
                            if (D = o(s(D, 0), 1), null == l["stroke-width"] && (G = f["stroke-width"]), l["stroke-width"] && (V.weight = G), G && 1 > G && (D *= G) && (V.weight = 1), V.opacity = D, l["stroke-linejoin"] && (V.joinstyle = l["stroke-linejoin"] || "miter"), V.miterlimit = l["stroke-miterlimit"] || 8, l["stroke-linecap"] && (V.endcap = "butt" == l["stroke-linecap"] ? "flat" : "square" == l["stroke-linecap"] ? "square" : "round"), "stroke-dasharray" in l) {
                                var W = {
                                    "-": "shortdash",
                                    ".": "shortdot",
                                    "-.": "shortdashdot",
                                ...
                                V.dashstyle = W[t](l["stroke-dasharray"]) ? W[l["stroke-dasharray"]] : d
                            }
                            O && c.appendChild(V)
                        }
                        if ("text" == y.type) {
