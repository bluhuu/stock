(function(l) {
    ...
    (function() {
        ...
        if (a) {
            c.ua.browser = true;
            if (/MSIE \d+/.test(a))
                c.ua.ie = a.match(/MSIE (\d)/)[1];
            else if (/KHTML/.test(a))
                c.ua.webkit = true;
            else if (/Gecko/.test(a))
                c.ua.gecko = true;
            else if (/Opera/.test(a))
                c.ua.opera = a.match(/Opera\/([0-9.]+)/)[1]
        }
    })();
    c._isDebug = false;
    c.debug = function(a) {
        this._isDebug = a === false ? false : true
    }
    ;
    c.isDebug = function() {
    ...
    c.each = function(a, b, d) {
        ...
        if (a)
            if (d)
                ...
                if (typeof a === "string" || typeof a.length !== "number" || a.tagName || a === this.global)
                    a = [a];
                e = 0;
    ...
    c.extend = function(a, b, d) {
        ...
        for (e in b)
            if (b.hasOwnProperty(e) && (d || a[e] === void 0))
                a[e] = b[e];
        return a
    }
    ;
    ...
    c.getUid = function(a) {
        ...
        if (!a)
            return a;
        b = a.uniqueID && a.nodeType && a.nodeType !== 9 ? a.uniqueID : typeof a === "string" ? a : a._duid;
        if (!b) {
            b = "_duid_" + ++c._uIdx;
            try {
                a._duid = b
    ...
    c.loadJs = function(a, b) {
        var d = c.doc, e = d.getElementsByTagName("head")[0] || d.documentElement, f, g, h = false;
        g = b.onSuccess;
        if (b.cache === false || c.isDebug() && b.cache !== true)
            a += (a.indexOf("?") > 0 ? "&" : "?") + "_du_r_t=" + Math.random();
    ...
    c.BasicModule.load = function(a, b) {
        ...
        if (b.preload)
            ...
            if (!g[a])
                if (f[a] !== void 0)
                    c.BasicModule.register("_", false);
                else {
                    g[a] = b;
                    c.loadJs(d, {
                        cache: b.cache
        ...
        if (h[a] === void 0) {
            ...
            if (f.length) {
                ...
                c.each(f, function(j) {
                    if (h[j] === void 0) {
                        n = false;
                        i[j] === void 0 && c.BasicModule.load(j, {
                            version: k && k.version
                        })
                    }
                });
                ...
                c.each(g, function(j, r) {
                    if (j && j != m) {
                        g[r] = false;
                        c.BasicModule.register.apply(c.BasicModule, j)
                    }
                })
            }
        }
    ...
    ;
    c.BasicModule.prototype.baseURI = c.baseURI || function() {
    ...
    c.BasicModule.prototype.getURI = function(a) {
        ...
        if (e.fullPath)
            b = e.fullPath;
        else if (e.afterBasePath)
            b = [b, e.afterBasePath].join("/");
        else {
            f = this.mname.split(":");
            g = f[1];
            f = f[0].split(".");
    ...
    ;
    c.asyncs && setTimeout(function() {
        c.each(c.asyncs, function(a) {
            c.load.apply(c, a)
        })
    }, 0)
})(this);
__.BasicModule.register("lang", "0.4.0", [], function() {
    ...
    __.lang.all = function(a, b, c) {
        ...
        if (c)
            for (d in a) {
                if (a.hasOwnProperty(d) && !b(a[d], d))
                    return false
            }
        else {
            if (typeof a === "string" || typeof a.length !== "number" || a.tagName || a === __.global)
                a = [a];
            d = 0;
    ...
    ;
    __.lang.reduce = function(a, b, c, d) {
    ...
    __.lang.unique = function(a, b) {
        return __.lang.reduce(a, function(c, d, e) {
            if (0 === e || (b ? c[c.length - 1] !== d : !__.lang.inArray(d, c, true)))
                c.push(d);
            return c
        }, [])
    }
    ...
    __.lang.curry = function(a) {
        var b;
        a = typeof a === "string" && __.lang.OPER[a] ? __.lang.OPER[a] : a;
    ...
    __.lang.clone = function(a) {
        ...
        for (c in a)
            if (a.hasOwnProperty(c))
                b[c] = __.lang.clone(a[c]);
        return b
    }
    ;
    __.lang.mergeObj = function() {
        var a, b, c, d = {};
        for (c = __.lang.a(arguments); (b = c.shift()) !== void 0; )
            for (a in b)
    ...
    __.lang.trim = function(a) {
        ...
        b = __.lang.getReg("\\s");
        for (c = a.length - 1; b.test(a.charAt(c)); )
            c--;
    ...
    __.lang.truncate = function(a, b, c, d) {
        ...
        if (d !== void 0 && f > b / 2) {
            ...
            a = a.length > b ? a.slice(0, b - c.length) + c : String(a);
        return a
    }
    ;
    ...
    __.lang.baseConvert = function(a, b, c) {
        ...
        if (c === void 0)
            c = __.lang.startWith(a, "0x") ? 16 : __.lang.startWith(a, "0") ? 8 : 10;
        a = parseInt(a, c);
        return a.toString(b)
    }
    ;
    ...
    __.lang.camelize = function(a) {
        ...
        for (a = 1; a < d; ++a)
            b += c[a].charAt(0).toUpperCase() + c[a].substring(1);
        return b
    }
    ;
    __.lang.underscore = function(a) {
        return a.replace(__.lang.getReg("([A-Z]+)([A-Z][a-z])", "g"), "$1_$2").replace(__.lang.getReg("([a-z\\d])([A-Z])", "g"), "$1_$2").toLowerCase()
    }
    ;
    ...
    __.lang.sprintf = function(a) {
        for (var b = 1; arguments[b] !== void 0; )
            a = a.replace(__.lang.getReg("%s"), arguments[b++]);
        return a
    }
    ;
    ...
    __.lang.greplace = function(a, b, c) {
        var d, e = __.lang.getReg(b, "g"), f = __.lang.getReg(b), g = "";
...
__.BasicModule.register("dom", "0.4.0", ["lang"], function() {
    ...
    __.dom.addClass = function(a, b) {
        if (!__.dom.hasClass(a, b))
            a.className = __.lang.trim([a.className, b].join(" "))
    }
    ;
    __.dom.remClass = function(a, b) {
        if (b && __.dom.hasClass(a, b)) {
            a.className = __.lang.trim(a.className.replace(__.lang.getReg("(?:^|\\s+)" + b + "(?:\\s+|$)"), " "));
    ...
    __.dom.addEl = function(a, b, d) {
        ...
        c = c || "div";
        if (__.ua.ie && (c === "input" || c === "select") && a.name)
            e = __.doc.createElement("<input name=" + a.name + ">");
        else if (c === "_text") {
            e = __.doc.createTextNode(a.text);
            a = {}
        } else
            e = __.doc.createElement(c);
        if (!e)
            return false;
        for (g in a)
    ...
    __.dom.remRules = function(a, b) {
        var d = b || __.dom._style || __.doc.styleSheets[0], e;
        if (d.deleteRule)
            e = true;
        else if (d.removeRule)
            e = false;
        else
            return;
        __.each(a, function(c) {
    ...
    __.dom.getWindowXY = function() {
        var a = __.global.innerHeight
          , b = __.global.innerWidth
          , d = __.doc.compatMode;
        if (d || __.ua.ie)
            if (d === "CSS1Compat") {
    ...
    __.dom.getDocumentXY = function() {
        ...
        d = __.dom.getWindowXY();
        return [Math.max(a, d[0]), Math.max(b, d[1])]
    }
    ;
    __.dom.setCenter = function(a) {
        a.style.position = "absolute";
        var b = __.dom.getWindowXY()
          , d = __.dom.getScrollXY()
          , e = a.offsetWidth || a.clientWidth || parseInt(a.style.width, 10)
          , c = a.offsetHeight || a.clientHeight || parseInt(a.style.height, 10);
    ...
    __.dom.contains = function(a, b) {
        if (a.contains && b.nodeType == __.lang.NODE_TYPE.ELEMENT_NODE)
...
__.BasicModule.register("event", "0.4.0", ["lang"], function() {
    ...
    __.event.on = function(a, c, f, d) {
        var b, g, h, i;
        if (a = __.event._getEl(a))
            if (__.lang.isArray(a))
                __.each(a, function(e) {
                    __.event.on(e, c, f, d)
                });
            else if (__.lang.isArray(c))
                __.each(c, function(e) {
                    __.event.on(a, e, f, d)
                });
            else {
                h = __.getUid(a);
                ...
                if (a.addEventListener)
                    a.addEventListener(g, b, !!d);
                else
                    a.attachEvent && a.attachEvent("on" + g, b);
                h.push(i);
                __.event.listeners++
            }
    }
            ...
            if (__.lang.isArray(a))
                ...
                if (g) {
                    if (a.removeEventListener)
                        a.removeEventListener(g.type, g.proxy, !!d);
                    else
                        a.detachEvent && a.detachEvent("on" + g.type, g.proxy);
                    __.event.listeners--
                }
            }
    }
    ...
    __.event.fire = function(a, c, f) {
        ...
        if (__.lang.isArray(b))
            __.each(b, function(g) {
                __.event.fire(g, c, f)
            });
        else {
            b = b || __.doc;
            if (b === __.doc && __.doc.createEvent && !b.dispatchEvent)
                b = __.doc.documentElement;
            ...
            } else if (b = __.event._allEvents[c])
                if (b = b[__.getUid(a)]) {
                    d = {
                        eventType: c,
                        eventName: c,
    ...
    __.event.onReady._bindReady = function() {
        ...
        if (!a._isBound) {
            ...
            if (__.ua.ie)
                a._domReadyId = setInterval(function() {
                    try {
                ...
                __.doc.addEventListener("DOMContentLoaded", a._hlReady, false);
            c = __.global.onload;
        ...
        if (a)
            if (a.nodeType)
                ...
                for (e = a.length; b < e; ++b)
                    c.push(a[b])
            } else if (__.lang.isString(a))
                c = (c = b ? null : __.dom.id(a)) ? [c] : __.selector.query(a, b, e);
            else
                c = [a];
        else
            c = [];
                        ...
                        for (g = b.length; a < g; ++a) {
                            ...
                            if (k) {
                                ...
                                for (n = l.length; m < n; m++)
                                    l[m].parentNode === b[a] && c.push(l[m])
                            } else
                                c = c.concat(__.lang.a(l))
                        }
                        j = f ? j : null ;
                        f = null
                    }
                    c = __.selector._nodeFilter(c, {
                        tagname: f,
                        classname: j
                    });
                    if (i && c[0]) {
...
__.BasicModule.register("io", "0.4.0", ["lang"], function() {
    ...
    __.io.Ajax.prototype.prepare = function() {
        var a = this.post;
        if (a)
            this.post = __.lang.isString(a) || !JSON ? a : JSON.stringify(a);
    ...
    __.io._ajaxManager = {
        ...
        abort: function(a) {
            ...
            if (c > -1) {
                ...
                __.each(this._requesting, function(d) {
                    if (d._duAmUid === a) {
                        d.abort();
                        b = true
                    }
        ...
        _try2Send: function() {
            ...
            if (!(this._requesting.length >= this._maxThread))
                for (; this._waiting.length; )
                    if (a = this._waiting.shift()) {
                        a = this._send(a);
        ...
        _finish: function(a) {
            ...
            if (a.readyState === 4 && a.status === 200) {
                ...
                if (c.target)
                    if (__.dom)
                        __.dom.fillText(__.dom.f(c.target), d);
                    else {
                        c.target.innerHTML = "";
    ...
    __.io.ajax = function(a, b, c) {
        c = c || {};
        if (__.lang.isFunction(b))
            c.onOk = b;
        else if (__.lang.isObject(b))
            c = b;
        if (__.lang.isObject(a))
            c = a;
        else if (__.lang.isString(a))
            c.sUrl = a;
...
__.BasicModule.register("anim", "0.4.0", ["lang"], function() {
    __.Anim = function(a, c, b) {
        ...
        this.onOver = __.lang.isUndefined(b.onOver) ? __.lang.EF : b.onOver;
    ...
    __.Anim.prototype._set = function(a) {
        ...
        if (this.isStyle)
            c = c.style;
        this.attr === "opacity" ? __.dom.setOpacity(this.el, a) : c[this.attr] = a + this.unit;
...
__.BasicModule.register("drag", "0.4.0", ["lang", "dom", "event"], function() {
    ...
    __.drag._attachEvent = function() {
        ...
        __.event.on(__.doc, "mouseup", __.drag._hlMouseup)
    }
    ;
    __.drag.begin = function(a, c, b, f, e, i, g) {
        ...
        if (!d.moved) {
            d.moved = true;
            if (h.position.toLowerCase().indexOf("absolute") === -1)
                h.position = "relative"
        }
        if (h.left)
            d.oriL = parseInt(h.left, 10);
        else {
            d.oriL = 0;
            h.left = "0px"
        }
        if (h.top)
            d.oriT = parseInt(h.top, 10);
        else {
            d.oriT = 0;
            h.top = "0px"
        }
        ...
        if (b)
            __.dom.setOpacity(c, g.opacity || 0.7);
...
__.BasicModule.register("history", "0.4.0", ["lang", "event"], function() {
    ...
    __.History.prototype.getHash = __.ua.gecko ? function() {
        var a = location.href.match(__.lang.getReg("#(.*)$"));
        return a && a[1] || ""
    }
    : function() {
    ...
    __.History.prototype._initEvents = function() {
        ...
        if (__.History.nativeHashChange)
            __.event.on(__.global, "hashchange", __.event.bind(this._handleChange, this));
        else if (!this._globalPollingId) {
            if (__.ua.webkit && navigator.userAgent.indexOf("Chrome") === -1 && navigator.vendor.indexOf("Apple") !== -1)
...
__.BasicModule.register("widget", "2.0.0", ["disposable"], function() {
    ...
    __.widget.Base.prototype._addCssRules = function(a) {
        this._cssRuleIds = __.dom.addRules(a)
    }
    ;
    ...
    __.widget.Base.prototype.onReady = function(a) {
        __.lang.isFunction(a) && this._onReady_.push(a);
...
__.BasicModule.register("jst", "0.4.0", [], function() {
    ...
    __.jst.Template.prototype.process = function(a, c) {
        ...
        for (b in __.jst.Template.modifierDef)
            f._MODIFIERS_[b] = f._MODIFIERS_[b] || __.jst.Template.modifierDef[b];
        for (b in this._MODIFIERS_)
            f._MODIFIERS_[b] = f._MODIFIERS_[b] || this._MODIFIERS_[b];
        try {
            this._func(h, f, c)
        } catch (d) {
            if (c.throwExceptions === true)
                throw d;
            b = String(e.join(""));
            b.exception = d;
            return b
    ...
    __.jst.Template.statementDef = {
        ...
        "for": {
            delta: 1,
            paramMin: 3,
            prefixFunc: function(a, c, b) {
                if (a[2] != "in")
                    throw new __.jst.Template.ParseError(b,c.line,"bad for loop statement: " + a.join(" "));
                c = a[1];
                b = "__LIST__" + c;
                return ["var ", b, " = ", a[3], ";var __LENGTH_STACK__;if (typeof(__LENGTH_STACK__) == 'undefined' || !__LENGTH_STACK__.length) __LENGTH_STACK__ = new Array();__LENGTH_STACK__[__LENGTH_STACK__.length] = 0;if ((", b, ") != null) { var ", c, "_ct = 0;for (var ", c, "_index in ", b, ") { ", c, "_ct++;if (typeof(", b, "[", c, "_index]) == 'function') {continue;}__LENGTH_STACK__[__LENGTH_STACK__.length - 1]++;var ", c, " = ", b, "[", c, "_index];"].join("")
            }
        },
        forelse: {
            delta: 0,
    ...
    ;
    __.jst.Template.ParseError.prototype.toString = function() {
    ...
    __.jst.Template._parse = function(a, c, b) {
        ...
        for (var e = ["var _Template_TEMP = function(_OUT, _CONTEXT, _FLAGS) { with (_CONTEXT) {"], h = {
            stack: [],
            line: 1
        }, f = -1; f + 1 < a.length; ) {
            var d = f;
            for (d = a.indexOf("{", d + 1); d >= 0; ) {
                ...
                if (g = a.substring(d, g).match(/^\{(cdata|minify|eval)/)) {
                    ...
                    var i = d + g.length + 1
                      , j = a.indexOf("}", i);
                    if (j >= 0) {
                        i = j - i <= 0 ? "{/" + g + "}" : a.substring(i + 1, j);
                        var k = a.indexOf(i, j + 1);
                        if (k >= 0) {
                            __.jst.Template.emitSectionText(a.substring(f + 1, d), e);
                            f = a.substring(j + 1, k);
                            if (g == "cdata")
                                __.jst.Template.emitText(f, e);
                            else if (g == "minify")
                                __.jst.Template.emitText(__.jst.Template.scrubWhiteSpace(f), e);
                            else
                                g == "eval" && f != null && f.length > 0 && e.push("_OUT.write( (function() { " + f + " })() );");
                            d = f = k + i.length - 1
                        }
                    }
                } else if (a.charAt(d - 1) != "$" && a.charAt(d - 1) != "\\") {
                    g = a.charAt(d + 1) == "/" ? 2 : 1;
                    if (a.substring(d + g, d + 10 + g).search(__.jst.Template.statementTag) == 0)
                        break
                }
                d = a.indexOf("{", d + 1)
            }
        ...
        if (h.stack.length !== 0)
            throw new __.jst.Template.ParseError(c,h.line,"unclosed, unmatched statement(s): " + h.stack.join(","));
    ...
    __.jst.Template.emitStatement = function(a, c, b, e, h) {
        var f = a.slice(1, -1).split(" ")
          , d = __.jst.Template.statementDef[f[0]];
        if (d == null )
            __.jst.Template.emitSectionText(a, b);
        else {
            if (d.delta < 0) {
                if (c.stack.length <= 0)
                    throw new __.jst.Template.ParseError(e,c.line,"close tag does not match any previous statement: " + a);
                c.stack.pop()
            }
            d.delta > 0 && c.stack.push(a);
            if (d.paramMin != null && d.paramMin >= f.length)
                throw new __.jst.Template.ParseError(e,c.line,"statement needs more parameters: " + a);
            typeof d.prefixFunc == "function" ? b.push(d.prefixFunc(f, c, e, h)) : b.push(d.prefix);
            if (d.suffix != null ) {
                if (f.length <= 1)
                    d.paramDefault != null && b.push(d.paramDefault);
                else
    ...
    __.jst.Template.emitSectionText = function(a, c) {
        ...
        if (!(a.length <= 0)) {
            ...
            for (e = 0; e < b.length; e++) {
                ...
                __.jst.Template.emitText(f.substring(i + g.length), d);
...
__.BasicModule.register("fn-boss", "0.4.0", ["disposable"], function() {
    ...
    __.FnBoss.prototype._get = function(a, b) {
        return [this.baseUri, a, this.uri2, (new Date).valueOf() % 1E4 * 1E4 + this.rand(9999), b ? "&" + b : "", "&iRand=", this.rand(99999999)].join("")
    }
    ;
    __.FnBoss.prototype.log = function(a, b, c, e) {
        ...
        if (!__.isDebug())
            if (a) {
                b = b || {};
                for (f in b)
                    b.hasOwnProperty(f) && h.push(encodeURIComponent(f) + "=" + encodeURIComponent(b[f]));
    ...
    ;
    __.FnBoss.prototype.disposeInternal = function() {
        var a = this.imgs;
...
__.BasicModule.register("fn-table", "2.0.0", ["lang", "dom"], function() {
    ...
    __.fnTable.getPageUrl = function(a, b) {
        ...
        case "0":
            if (a.length > 5)
                f = "http://gu.qq.com/jj" + a;
            break;
        case "1":
            f = "http://gu.qq.com/sh" + a;
            break;
        case "51":
            f = "http://gu.qq.com/sz" + a;
            break;
        case "100":
            f = "http://gu.qq.com/hk" + a;
            break;
        case "200":
        case "real":
        case "delay":
            f = "http://gu.qq.com/us" + a.toUpperCase();
            break;
        case "300":
            f = "http://gu.qq.com/qh" + a.toUpperCase();
            break;
        case "350":
            f = "http://gu.qq.com/qh" + a.toUpperCase();
            break;
        case "61":
            f = "http://gu.qq.com/nq" + a.toUpperCase()
        }
    ...
    __.fnTable.fill = function(a, b, f, c) {
        ...
        k = [];
        if (__.lang.isString(a))
            __.each(a.split(","), function(h) {
                var l = __.global["v_" + h];
                k.push(l ? l.split("~") : h)
            });
        else if (__.lang.isArray(a))
            __.each(a, function(h) {
                if (__.lang.isString(h))
                    h = (h = __.global["v_" + h] || h) && h.split("~");
                k.push(h)
            });
        else
            return;
        ...
        for (d = a.length; b < d && b < o; b++) {
            n = true;
            if (!__.lang.isObject(a[b]) && (!__.lang.isArray(a[b]) || a[b].length < 2))
                if (c.showError)
                    a[b] = [];
                else
                    n = false;
            if (n) {
                ...
                g = e;
                n = a[b];
                if (b % 2 === 0 && (c.evenTr || c.evenTr === ""))
                    e.style.cssText = c.evenTr;
                else if (b % 2 === 1 && (c.oddTr || c.oddTr === ""))
                    e.style.cssText = c.oddTr;
                j = g.firstChild;
    ...
    ;
    __.fnTable.fastFill = function(a, b, f, c) {
        ...
        i = [];
        if (__.lang.isString(a))
            __.each(a.split(","), function(l) {
                var p = __.global["v_" + l];
                i.push(p ? p.split("~") : l)
            });
        else if (__.lang.isArray(a))
            __.each(a, function(l) {
                if (__.lang.isString(l))
                    l = (l = __.global["v_" + l] || l) && l.split("~");
                i.push(l)
            });
        else
            return;
        ...
        for (e = a.length; d < e && d < o; d++) {
            g = true;
            if (!__.lang.isArray(a[d]) || a[d].length < 2)
                if (c.showError)
                    a[d] = [];
                else
                    g = false;
    ...
    __.fnTable.process = function(a, b, f, c, d) {
        ...
        if (b.length === 1) {
            e = "--";
            if (__.lang.isFunction(a))
                try {
                    e = a(b, f, c, d)
                } catch (g) {}
            else if (__.lang.isString(a) && !__.lang.isFunction(__.fnTable.processors[a]))
                e = a
        } else {
            e = __.lang.isFunction(a) ? a(b, f, c, d) : __.lang.isFunction(__.fnTable.processors[a]) ? __.fnTable.processors[a](b, f, c) : !__.lang.isUndefined(b[a]) ? b[a] : __.lang.isString(a) ? a : b[f];
    ...
    __.fnTable.processors = {
        ...
        L_CHANGE: function(a) {
            return __.fnTable.processors.GET_SIGNED_COLOR(a[31], a[31])
        },
        ...
        GET_SIGNED_COLOR: function(a, b, f) {
            return __.fnTable.processors.GET_COLOR((b > 0 ? "+" : "") + a, b, f)
        },
    ...
    __.fnTable.sort = function(a, b, f, c) {
        var d = __.dom.f(a), e = __.dom.$("tr", d), g = [], n = __.lang.getReg("^\\s+$"), j = {}, m, o = null , i = function(k) {
            k = k.cloneNode(true);
            var h = [];
            if (k && k.nodeType === __.lang.NODE_TYPE.TEXT_NODE)
                n.test(k.nodeValue) || h.push(k.nodeValue);
            else
                k && k.nodeType === __.lang.NODE_TYPE.ELEMENT_NODE && k.hasChildNodes() && __.each(k.childNodes, function(l) {
                    h.push(i(l))
                });
            return h.join("")
        };
    ...
    __.fnTable.pFill = function(a, b, f) {
        var c, d;
        __.lang.isString(a) && __.each(a.split(","), function(e) {
            if (__.global["v_" + e])
                if (__.lang.isString(a))
                    a = [__.global["v_" + e]];
                else
                    a.push(__.global["v_" + e])
        });
...
__.BasicModule.register("fn-cronloader", "2.0.0", ["lang", "dom", "fn-table", "clientstore"], function() {
    __.FnCronLoader = function(a) {
        a = a || {};
        if (a.pushBases)
            __.FnCronLoader.pushBases = a.pushBases;
        if (a.pushDummy)
    ...
    __.FnCronLoader.prototype._getPushBase = function() {
        var a = __.FnCronLoader.pushBases.length
          , d = parseInt(__.clientStore.get("du_push_id"), 10);
    ...
    __.FnCronLoader.prototype._consumePushJob = function() {
        ...
        for (__.each(this.jobs[0], function(e) {
            ...
            this._updateSession(this._assignSession(a, d))
        }
    }
    ;
    ...
    ;
    __.FnCronLoader.prototype._updateSession = function(a, d) {
        var b, c, f;
        f = this.jobs[0];
    ...
    __.FnCronLoader.prototype._sendPushReq = function(a) {
        ...
        if (!(this._paused || !b || !b.running || this.pushCount > this._maxCount)) {
            ...
            if (!b.iframe)
                b.iframe = __.FnCronLoader._getIframe();
    ...
    __.FnCronLoader.prototype._onDataLoaded = function(a, d, b) {
        ...
        __.each(d, function(j) {
            if (c = g.getJobById(j, e))
                if (c && c.onData)
                    if (!c.__created || e && !c.__created[b]) {
                        c.onData(a, f);
                        if (e)
                            c.__created[b] = true;
                        else
    ...
    __.FnCronLoader.prototype._addPolling = function(a) {
        ...
        if (d && __.lang.isInt(a.judge) && d > 0)
            a.judge = function(f) {
                if (f % d === 0)
                    return 3;
                return 0
    ...
    __.FnCronLoader.prototype._remPushJob = function(a) {
        ...
        var g = this;
        if (this.jobs[0]) {
            b = __.lang.findByAttr(this.jobs[0], "id", a);
            if (b > -1) {
                d = this.jobs[0][b];
    ...
    ;
    __.FnCronLoader.prototype.addJob = function(a) {
        var d;
        if (a.keys) {
        ...
        if (__.lang.isUndefined(a.interval))
            a.interval = __.FnCronLoader.defaultInterval;
        d = ++this._jobUidIdx;
        a.id = d + "-" + a.interval;
        if (a.type === 2 || !this.isPushUsable() || !a.keys || a.keys.length === 0)
            this._addPolling(a);
        else {
    ...
    __.FnCronLoader.prototype.remJob = function(a) {
        ...
        d = a.split("-")[1];
        if (this.jobs[d]) {
            b = __.lang.findByAttr(this.jobs[d], "id", a);
            if (b > -1) {
                __.lang.arrayRemove(this.jobs[d], b);
                b = true
            } else
                b = this._remPushJob(a)
        }
        return b
    }
    ;
...
__.BasicModule.register("compat", "0.0.0", ["dom", "event", "lang", "selector", "cookie", "fn-table"], function() {
    ...
    __.Class = function() {
        var a, d = false, b = __.lang.getReg("xyz").test(function() {}) ? __.lang.getReg("\\b_super\\b") : __.lang.getReg(".*");
        a = function() {}
        ;
        a.extend = function(c) {
            function e() {
            ...
            for (f in c)
                if (c.hasOwnProperty(f))
                    h[f] = typeof c[f] === "function" && typeof g[f] === "function" && b.test(c[f]) ? i(f, c[f]) : c[f];
            e.prototype = h;
            e.constructor = e;
    ...
    ;
    __.CronLoader.prototype.pause = function() {
        this._cron.pause()
    }
    ;
    ...
    __.CronLoader.prototype.subscribe = function(a) {
        var d = this;
        return this._cron.addJob({
            type: 2,
            keys: a.qtName && a.qtName.split(",") || [],
            judge: typeof a.judge == "function" ? function(b) {
    ...
    ;
    __.BasicModule.register("fn-base", "0.0.0", ["dom", "event", "lang", "selector", "cookie", "fn-table"], function() {});
    __.BasicModule.add("fn-dataproxy", {
        fullPath: "http://mat1.gtimg.com/finance/st/g/fn-dataproxy/fn-dataproxy_1.3.js"
    });
    __.BasicModule.add("fn-pushloader", {
        fullPath: "http://mat1.gtimg.com/finance/st/g/fn-pushloader/fn-pushloader_1.0h.js"
    });
    __.BasicModule.add("fn-pricebox", {
        fullPath: "http://mat1.gtimg.com/finance/st/g/fn-pricebox/fn-pricebox_1.9.js"
    });
    __.BasicModule.add("fn-msgpopup", {
        fullPath: "http://mat1.gtimg.com/finance/st/g/fn-msgpopup/fn-msgpopup_1.1.js"
    });
    __.BasicModule.add("stock-diy", {
        fullPath: "http://mat1.gtimg.com/finance/st/p/stock-diy/stock-diy_1.38.js"
    });
    __.BasicModule.add("stock-diyb", {
        fullPath: "http://mat1.gtimg.com/finance/st/p/stock-diy/stock-diy_1.39a.js"
    });
    __.BasicModule.add("stock-diyc", {
        fullPath: "http://mat1.gtimg.com/finance/st/p/stock-diy/stock-diy_1.37.js"
    })
});
__.BasicModule.register("data", "0.4.0", [], function() {
    __.exportPath("__.data");
    __.data.Quote = function(a) {
        if (!this instanceof __.data.Quote)
            return new __.data.Quote(a);
        this.data = a.split("~");
...
__.BasicModule.register("jslog", "0.4.0", ["lang", "cookie", "fn-boss", "event"], function() {
    ...
    __.jslog.getEnv = function() {
        ...
        try {
            ...
            if (b.language)
                a.lang = b.language.toLowerCase();
            else if (b.browserLanguage)
                a.lang = b.browserLanguage.toLowerCase();
    ...
    __.jslog.stack = function(a) {
        ...
        if (a.arguments && a.stack)
            e = "chrome";
        else if (a.message && typeof window !== "undefined" && window.opera)
            e = a.stacktrace ? "opera10" : "opera";
        else if (a.stack)
            e = "firefox";
    ...
    __.jslog.stack.opera10 = function(a) {
        ...
        var e = /.*line (\d+), column (\d+) in ((<anonymous function\:?\s*(\S+))|([^\(]+)\([^\)]*\))(?: in )?(.*)\s*$/i, b, c, d;
        b = 2;
        c = 0;
        for (d = a.length; b < d - 2; b++)
            if (e.test(a[b])) {
    ...
    __.jslog.stack.opera = function(a) {
        ...
        b = 4;
        c = 0;
        for (d = a.length; b < d; b += 2)
            if (e.test(a[b]))
                a[c++] = (RegExp.$3 ? RegExp.$3 + "()@" + RegExp.$2 + RegExp.$1 : "{anonymous}()@" + RegExp.$2 + ":" + RegExp.$1) + " -- " + a[b + 1].replace(/^\s+/, "");
        a.splice(c, a.length - c);
        return a
    }
    ;
        ...
        for (var e = Array.prototype.slice, b = __.jslog.stack, c = 0; c < a.length; ++c) {
            ...
            if (d === undefined)
                ...
                if (d.constructor === Array)
                    a[c] = d.length < 3 ? "[" + b.stringifyArguments(d) + "]" : "[" + b.stringifyArguments(e.call(d, 0, 1)) + "..." + b.stringifyArguments(e.call(d, -1)) + "]";
    ...
    __.jslog.error = function(a, e) {
        ...
        __.jslog.boss.log(e || 1, {
            file: location.href,
            js: a.fileName,
            line: a.lineNumber,
            msg: a.message,
            env: __.jslog._envstr,
            stack: __.jslog.stack(a).join("\n")
        })
    }
    ;
...
__.BasicModule.register("tools", "0.0.0", [], function() {
    ...
    __.tools.ifLoad = function(b, a, e) {
        ...
        if (!a.id) {
            var d = __.tools.ifLoad._gPrefix + __.tools.ifLoad._gId++;
            b = b.split("?");
            if (e) {
                b[1] = b[1] ? b[1] + "&" + e + "=" + d : "&" + e + "=" + d;
                window[d] = function(c) {
        ...
        __.load(b, function() {
            if (window[a.id]) {
                ...
                __.jslog.iferror(b, -1, "[" + a.id + "] is not defined")
        })
    }
    ;
...
/*  |xGv00|c3139f06b12d3784e27b2da004bfdcbc */
